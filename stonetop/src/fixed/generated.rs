...
pub(super) static SETTING_OVERVIEW: stonetop::fixed::SettingOverviewFixed =
    stonetop::fixed::SettingOverviewFixed {
        title: "Setting Overview",
        sections: &[
            stonetop::fixed::SettingSection {
                heading: "The premise",
                html: "<p>You play the heroes of <strong>Stonetop</strong>, an isolated village near the edge of the known world. Adventures focus on dealing with threats to the village, seizing opportunities for the village, or pursuing personal goals. Months or years might pass between adventures.</p>",
                subsections: &[],
            },
            stonetop::fixed::SettingSection {
                heading: "The village itself…",
                html: "<p><strong>…is home to around 300 folks.</strong> It's a nice place, though poor. Here, people look out for each other.</p><p><strong>…is built around a massive standing stone of unknown origin</strong>, carved with faint runes. Lightning strikes the Stone often.</p><p><strong>…stands at the edge of the Great Wood.</strong> Villagers hunt and trap but—per a compact with the Forest Folk—never fell a living tree.</p>",
                subsections: &[],
            },
            stonetop::fixed::SettingSection {
                heading: "Neighbors",
                html: "<p>The <strong>Forest Folk</strong> disappeared ten years ago, and no one knows why. Perhaps the <strong>Fae</strong>—magical, fickle beings of the Great Wood—had something to do with it?</p><p>Horrid little <strong>crinwin</strong> also lurk in the Great Wood. They've grown bolder and more numerous since the Forest Folk left.</p><p><strong>Gordin's Delve</strong> is a rugged mining village a few days to the west.</p><p>The <strong>Hillfolk</strong> roam the rugged Steplands and the Flats, and revile Gordin's Delve.</p><p><strong>Marshedge</strong> is a sizeable town about ten days' march south and east.</p><p><strong>Barrier Pass</strong> is a few days north in the mountains; stoic, grim, unwelcoming.</p><p>There's no empire, no kings or nobles—at least not around here. More “civilized” towns and cities lie farther to the south.</p>",
                subsections: &[],
            },
            stonetop::fixed::SettingSection {
                heading: "The Makers",
                html: "<p>The Makers are long gone, but their ruins (many sized for giants) remain. <strong>Stonetop is built on Maker-ruins:</strong> an ancient cistern, the crumbling Old Wall, some old foundations. <strong>The Ruined Tower</strong> is about a day from town. <strong>The West Road</strong> stretches from Stonetop to Gordin's Delve. <strong>The Highway</strong> crosses the West Road a few miles from town, stretching from Barrier Pass to Marshedge and beyond.</p>",
                subsections: &[],
            },
            stonetop::fixed::SettingSection {
                heading: "Other things of note",
                html: "<p><strong>The PCs are all human.</strong> Strange peoples (like the <strong>Forest Folk</strong> or <strong>the Fae</strong> or the mask-wearing <strong>Ustrina</strong> from beyond Gordin's Delve) are known of but poorly understood.</p><p>Wise folk whisper of the <strong>Things Below</strong>, primeval entities of darkness, corruption, and ruin. Their power taints all that it touches.</p><p><strong>People are terrified of deep water.</strong> Evil dwells there. Evil that will drag you to your doom. Everyone knows this.</p><p><strong>Magic is not common, nor easy, nor safe.</strong> It can be borrowed from spirits or gods or Things Below, or wrested from the forgotten lore of the Makers. But it is not to be trifled with.</p><p><strong>Iron</strong> is the most common metal. Good steel is hard to find. <strong>Bronze</strong> tools and weapons are common enough, but old-fashioned and dripping with superstition.</p>",
                subsections: &[],
            },
            stonetop::fixed::SettingSection {
                heading: "The characters",
                html: "<p>You'll play a local hero, someone with deep ties to Stonetop. You might be…</p><ul><li><strong>The Blessed</strong> (medium complexity): nature priest. Speaks to spirits and beasts. Works subtle magics via sacred markings and materials.</li><li><strong>The Fox</strong> (low complexity): clever, quick, and skillful. Not above bending the rules or fighting dirty. Can be quite the charmer, too.</li><li><strong>The Heavy</strong> (low/medium complexity): not just a violent individual—<em>Stonetop's</em> violent individual. A champion, yes, but a bit of a liability, too.</li><li><strong>The Judge</strong> (low complexity): settler of disputes, chronicler, and divine bulwark against chaos. Insightful, tough, not necessarily persuasive.</li><li><strong>The Lightbearer</strong> (high complexity): invokes divine power via flame and candle. Beacon of hope, charity, and mercy. Fiery foe of the dark.</li><li><strong>The Marshal</strong> (high complexity): leads the town's militia, plus a crew of followers. Makes choices about who lives and who dies.</li><li><strong>The Ranger</strong> (low complexity): at home in the wild, the one you want with you when you travel. A resourceful guide and deadly hunter.</li><li><strong>The Seeker</strong> (high complexity): collector of lost lore and power, with potent artifacts that might well lead to their ruin.</li><li><strong>The Would-Be Hero</strong> (medium complexity): They're in over their head and full of fear and anger, but they just might outshine us all.</li></ul>",
                subsections: &[],
            },
            stonetop::fixed::SettingSection {
                heading: "Your agenda",
            ...
            stonetop::fixed::SettingSection {
                heading: "Content",
                html: "<p>By default, this game features:</p><ul><li>Fairly graphic violence</li><li>Kidnapping, abductions, families in danger</li><li>Bigotry, racial tensions</li><li>Horror elements, mind control, possession</li><li>Personal corruption (esp. for the Seeker)</li><li>Starvation (or the threat thereof)</li></ul><p>Other disturbing and emotional topics are certainly possible. Talk to your group about any topics that you wish to exclude, veil, or handle in a specific way.</p>",
                subsections: &[],
            },
            stonetop::fixed::SettingSection {
                heading: "Stonetop — The village itself",
                html: "<ul><li><strong>Size</strong> <em>village</em> (~300 souls)</li><li><strong>Population</strong> +0</li><li><strong>Prosperity</strong> +0 (farming, hunting/trapping, distilling (whisky), stone (from Old Wall), cistern, tradesfolk (potter, midwife, publican, smith, tanner), trade with Gordin's Delve, Marshedge)</li><li><strong>Defenses</strong> +0 (militia, the Ringwall (low, stone), three watchtowers, spears &amp; shields in every home, some bows)</li></ul><p>Stonetop is a tight-knit community. Everyone here is expected to pull their weight, but few think badly of those who suffer misfortune. The town pulls together; its community is its strength.</p><p>Able-bodied adults are expected to know how to fight and protect the village when needed. Everyone keeps a spear, a round wooden shield, and maybe a bow. Folk rotate through guard duty, manning the three <strong>watchtowers</strong> each night. There's no government, just leaders. Everyone knows who they are: the wise, the cunning, the brave. It's not a formal thing.</p><p>Most buildings are low and squat, built from stones scavenged from the crumbling <strong>Old Wall</strong> that surrounds the town about a mile out from the village center. Roofs are mostly thatched with barley straw. Families pass these homes on, two or three generations living in one or two buildings at a time.</p><p><strong>The Ringwall</strong> is a waist-high fieldstone wall. Of little to no use against a real army, it nonetheless provides some defense against raiders. The houses built outside the Ringwall are newer, built by younger families or more recent immigrants.</p><p>Most folk in town are farmers, growing barley, oats, beans, and potatoes in the surrounding land. <strong>The fields</strong> stretch out from Stonetop to the edge of the Old Wall. Beyond that, the weedy grasses of the Flats choke out anything the villagers might plant.</p><p>The town boasts only a few full-time tradesfolk: a smith, a tanner, a midwife, a publican, and a potter. Other crafts—thatching, carpentry, weaving, and so forth—are done on the side. There's no mill, not much in the way of bread. Families keep goats for milk, chickens for eggs, sheep for wool, pigs for meat. The town owns two horses in common, a couple plows, a pair of carts, and a wagon acquired in trade from Marshedge.</p><p>Well over 50 feet tall and etched in faded runes, <strong>the Stone</strong> appears to be older even than the giant-sized Maker ruins upon which the village was founded.</p><p>When storms roll in from the southeast—as they often do during the spring and summer months—lightning strikes the Stone repeatedly. The locals barely even notice.</p><p>Foodstuffs are stored in <strong>the Granary</strong> for winter. Everyone contributes, everyone shares.</p><p>Sane folk shun lakes, rivers, and other deep bodies of water. Death dwells in deep water—everyone knows this.</p><p>To get through the dry months, the residents of Stonetop store rainwater, snowmelt and water from the Stream in a huge, ancient <strong>Cistern</strong>.</p><p><strong>The Public House</strong> is the largest building in the village, where everyone meets after sundown to drink and socialize. It offers floor space in the common room for travelers and a small stable under the same roof. The town's two horses are kept here.</p><p>The village sits on a bluff overlooking <strong>the Great Wood</strong>. A few brave souls ply its depths for meat and fur to trade with Stonetop's neighbors. Trappers bring in most of the wealth, but hunters get more respect. It's dangerous down there.</p><p>Stonetop boasts no temple but does have a <strong>Pavilion of the Gods</strong>, hosting shrines to <strong>Helior</strong> (the Daybringer), <strong>Danu</strong> (the Earth Mother), <strong>Aratis</strong> (the Lawkeeper), and <strong>Tor</strong> (Rain-Maker, Thunderhead, Slayer-of-Beasts). Tor is the most popular and associated with the Stone itself, but all four gods are given due respect.</p><p>By compact with <strong>the Forest Folk</strong>, the villagers never cut down a living tree. They're free to gather fallen wood, but if they need timber they send folk northwest to the Foothills. Yet no one's laid eyes on the Folk for a decade, and some grumble that there's plenty of timber down there, in their own back yard.</p><p>The <strong>crinwin</strong>—diminutive, gray-skinned creatures with a penchant for mimicry—lurk in the Great Wood. The Forest Folk once hunted them and kept them in check, but their numbers have been growing.</p><p>The Wood is also home to the strange and magical <strong>Fae</strong>. The Forest Folk called them “Good Neighbors” and took pains to avoid insulting them. They cautioned Stonetop to do the same.</p><p><strong>The Stream</strong> runs along the base of the bluff, providing a source of fresh water for those willing to haul buckets back and forth. It's been known to dry up at the height of summer. The villagers fear shallow running water less than the deep stuff, but most agree that the Stream is haunted by a pair of ghostly twins.</p>",
                subsections: &[stonetop::fixed::SettingSubsection {
                    heading: "Map: The village of Stonetop",
                    html: "<p>The Stone, a large obelisk, is closely surrounded by the Granary to the north, the Public House to the northeast, the Pavilion to the east and the Cistern to the southeast, as well as houses all around. Most of the houses are surrounded by the Ringwall, but a few stand outside it in the southwest and southeast. Beyond the houses are The Fields in a semicircle from the northwest to the southeast. There is a bluff to the east; at the bottom of the bluff lies The Great Wood, with The Stream running through the Wood at the southeast corner of the map.</p><p>The northwest, southwest, and southeast corners of The Fields are labeled \"to the Old Wall\", while a path through The Fields going west and slightly south is labeled \"to West Road\".</p>",
                }],
            },
            stonetop::fixed::SettingSection {
                heading: "The Vicinity — The village's immediate surroundings",
                html: "<p>The villagers never fell a living tree from the Great Wood, so when they need timber they send the wagon and some hearty souls into <strong>the Foothills</strong>. It's two days out, a day of hard work, and another two or three days to make the return trip.</p><p>And while the Highway and the West Road are relatively safe, the Foothills themselves are haunted by at least one fell beast or monster. Surely, a trip to the Foothills is a scary thing. But sometimes it has to be done.</p><p><strong>The Flats</strong> are a wide open prairie between the Great Wood and the Huffel Peaks. They are overrun with weedy, bitter-tasting grasses that choke out most other vegetation.</p><p>Traversing the Flats can feel like an exercise in loneliness, but the land is teeming with life. Most of it will ignore travelers, but the tall grasses might conceal cougars, wolves, or packs of hunting drakes. Aurochs, horses, and deer roam the prairie, and bands of Hillfolk come north from the Steplands to hunt.</p><p>Wise travelers keep to the ancient roads. The Makers' old magic keeps them in good repair, and predators shun them. But tales tell of dancing lights and strange spirits luring the unwary off the roads at night.</p><p><strong>The Ruined Tower</strong> lies a long day's march from Stonetop, a good half-day's trek from the roads. It's hardly still a tower, more a pile of enormous stones and earth. Everyone in town knows about the giant-sized tunnels beneath the tower. Adventuresome folks get it in their heads to go there now and then, but they usually just go a little way in and get spooked. There are people who've gone deeper—generations back—and brought back amazing things.</p><p>Little of that stuff remains in town, long since traded away, but the stories linger.</p><p>There's a cave called <strong>the Maw</strong> in the Great Wood, a few hours north of town. No underbrush grows within thirty feet of it, and bones litter the entrance. Trappers and hunters avoid it, and claim to have heard strange noises coming from its direction—especially at night.</p><p>The <strong>Old Wall</strong> surrounds Stonetop, about a mile out from the Stone itself and at the end of the West Road. It was clearly once a massive rampart, but has tumbled and been buried by the ages. When the villagers need stone for construction, they dig it out of the Old Wall and haul it back to town.</p><p>Occasionally, some crackpot scholar from the south comes up to study the remains of the Old Wall, but they can rarely stand the “primitive” conditions out here for long.</p><p>On certain nights, <strong>the Pale Hunter</strong> stalks the Great Wood, and when he does even the bravest hunters stay in town. The Forest Folk spoke of him as something like a force of nature, not so much a god to be worshiped as a storm to be weathered.</p><p>The tales differ as to what happens should you cross the Hunter. He might ignore you, call you to join his raid, or mark you as his quarry. But all the tales agree: impress him, and you'll be well rewarded. Get caught or fail to do your part—well, best not to think of it.</p><p><strong>The Red Grove</strong> is a stand of trees in the forest that turn blood red—leaves, bark, and all—near the autumnal equinox. But by springtime, they're back to normal.</p><p>The Forest Folk never went near this grove, and warned the townsfolk to avoid it as well. They never said why.</p><p>Since the Folk disappeared, <strong>the Great Wood has grown more dangerous</strong>. Crinwin encroach upon the village. Deer carcasses can often be found strung up in trees, cocooned in silky webs. And all too often, hunters and trappers come home with tales of freshly unearthed ruins or twisted, unnatural beasts.</p><p>A pair of <strong>cave bears</strong> have a den in the bluffs just south of town. Villagers know to steer clear, but in a pinch a bear could feed a whole lot of people. Also, who knows what else is in their den? Perhaps it opens up to a larger network of caverns.</p><p>The area's always had earthquakes, but the elders say they come more often now. Maybe <strong>the Crombil</strong>, that fiery serpent of woe, stirs in its sleep. Or maybe some other evil, long buried, now strains to be free.</p>",
                subsections: &[stonetop::fixed::SettingSubsection {
                    heading: "Map: The Vicinity",
                    html: "<p>Stonetop is halfway to the eastern edge of this map, at the tip of a bluff pushing into The Great Wood. In the Great Wood are The Maw, north of and relatively close to Stonetop, Red Grove to the east, and Cave Bears to the south. Red Grove and Cave Bears are about twice as far from Stonetop as The Maw.</p><p>The West Road leads west from Stonetop and eventually to Gordin's Delve, crossing The Highway at The Crossroads. The Highway runs from Barrier Pass in the northwest to Steplands and Marshedge in the southeast. Both are off this map. We do see The Highway passing through The Foothills near the northwest corner of the map. The Flats take up the southwest corner of the map. The Ruined Tower is in the southwest quadrant, not on any road.</p>",
                }],
            },
            stonetop::fixed::SettingSection {
                heading: "The World's End — The region in which Stonetop sits",
                html: "<p>To the north run the <strong>Whitefang Mountains</strong>, said to be home to both savage giants and many mysterious villages. Little is known about what lies beyond. Throughout the long summers, thunderstorms roll up from the southeast and crash against the mountains. When they do, green and purple lights can be seen dancing around the crown of the peak known as <strong>Tor's Fist</strong>.</p><p><strong>Barrier Pass</strong> is blocked by a massive wall and gate, held by stoic, unfriendly folk who want little to do with strangers. They live on mountain goats and sheep and gods know what else, and brook no trespass. The town elders tell of their kind coming down every generation or two to trade some ancient wonder for crops or goats, but none alive remember such a visit.</p><p><strong>Gordin's Delve</strong> is a mining town in the <strong>Huffel Peaks</strong>. Folk make their way here when they're on the run or when there's nothing left back home. The Delve is named for the Maker-made passages that plunge under the mountains. There lies <strong>the Labyrinth</strong>, home to foul raiders who've forgotten the light of day. But mask-wearing <strong>Ustrina</strong> sometimes come from the depths to trade fine goods, curiosities, and the rare bit of orichalcum.</p><p>About two days' hike from Stonetop is <strong>Titan Bones</strong>, a lone hill amidst the Flats. A huge fossilized skeleton is visible on one side of the hill. When Stonetop or the Hillfolk need to signal each other, they light a huge bonfire atop the hill.</p><p><strong>The Steplands</strong> are a rugged wilderness, home to the nomadic <strong>Hillfolk</strong>: horselords and shepherds, fierce and barbaric to outsiders. They trade horses, wool, and sometimes salt from the south, but consider Gordin's Delve corrupt for prying sacred metals from the earth.</p><p>The Steplands are dotted with ancient <strong>burial mounds</strong>. Unlike most ruins, these are man-sized and less sophisticated than those of the Makers. The Hillfolk shun them and warn all travelers away.</p><p>On a clear day, sharp-eyed folk in Stonetop can spot the <strong>Golden Oak</strong>. The Forest Folk said that a hero buried at its roots would return from beyond the Last Door. But no one from Stonetop has ever made it there and back.</p><p>The reaches of the <strong>North Manmarch</strong> are home to an aggressive, warlike people who dwell in wooden longhouses. Fortunately for their neighbors, they fight amongst themselves in an eternal cycle of blood-feud. Should a leader unite them one day, they will be a terror to all the world.</p><p><strong>Marshedge</strong> is a proper town, with a wooden palisade, market, and town council. They grow hemp and wheat, and collect wild rice and herbs from <strong>Ferrier's Fen</strong>. But no one ventures too deep into the Fen. Scaly, slimy suarachan drag fools away to sacrifice to their foul gods.</p><p>A few years back, the council asked a notorious bandit named <strong>Brennan</strong> to take the job of marshal. He's still in charge, and his old gang—the Claws—dominate the town watch of Marshedge.</p><p>The <strong>Dread River</strong> marks the eastern edge of the known world. None get too close, but a sprawl of ruins can be spotted at the end of the Highway. Folktales speak of fools braving the ruins only to disappear forever, or (worse) return with some cursed relic in hand.</p><p>The Steplands hide two great terrors: <strong>Blackwater Lake</strong> (to the west) and <strong>Three-Coven Lake</strong> (to the east). The Hillfolk wisely keep their distance, but the few who have dared approach the lakes report ancient ruins on the shores, in the surrounding cliffs, and even beneath the waters.</p><p>The plains of the <strong>South Manmarch</strong> are sparsely inhabited, by a few tribes of nomads hunting aurochs herds. But trade is steady between Marshedge and Lygos and the other towns of the arid south.</p>",
                subsections: &[stonetop::fixed::SettingSubsection {
                    heading: "Map: The World's End Region",
                    html: "<p>The Huffel Peaks rim the western edge of this map and the Whitefang Mountains the northern edge. They meet at The Barrier Pass, at the northwest corner of the map. Gordin's Delve is somewhat south of The Barrier Pass, in the Huffel Peaks, and Tor's Fist east of The Barrier Pass in the Whitefang Mountains. Stonetop and its vicinity are in the northwest quadrant of the map, and The Great Wood extends east of Stonetop almost to the edge of the map. The Golden Oak is east and slightly north of Stonetop, about as far to Stonetop's east as Gordin's Delve is to its west.</p><p>The Highway runs from Barrier Pass in the north, passing near Stonetop and the hill called Titan Bones south of Stonetop, then goes first through The Flats and the Steplands, then Marshedge, eventually reaching the Dread River. Before Marshedge, in the middle of the Steplands, the Highway crosses an unnamed road (or maybe a river) connecting Ferrier's Fen to the north and east of Marshedge to Blackwater Lake in the west. A definite river flows from Blackwater Lake southeast to Three-Coven Lake in the central south of the map and then on to Marshedge. East of The Great Wood, Marshedge, and Three-Coven Lake and west of the Dread River are South Manmarch and North Manmarch. The southeast corner of the map is labeled \"to Lygos and other points south\".</p>",
                }],
            },
        ],
    };
...
static GIZMO_SKIN_OF_FINE_WHISKY: stonetop::fixed::GizmoFixed = stonetop::fixed::GizmoFixed {
    key: stonetop::keys::GizmoKey::SkinOfFineWhisky,
    name: "Skin of fine whisky",
    material: None,
    piercing: None,
    slots: stonetop::fixed::SlotCount::Zero,
    description: "({resource} uses; share a use with someone to get advantage on Persuade)",
    resource: Some(stonetop::fixed::Resource {
        hold: "Uses",
...
static GIZMO_FIRKIN_OF_FINE_WHISKY: stonetop::fixed::GizmoFixed = stonetop::fixed::GizmoFixed {
    key: stonetop::keys::GizmoKey::FirkinOfFineWhisky,
    name: "Firkin of fine whisky",
    material: None,
    piercing: None,
    slots: stonetop::fixed::SlotCount::Two,
    description: "",
...
static GIZMO_SKIN_OF_COMMON_WHISKY: stonetop::fixed::GizmoFixed = stonetop::fixed::GizmoFixed {
    key: stonetop::keys::GizmoKey::SkinOfCommonWhisky,
    name: "Skin of common whisky",
    material: None,
    piercing: None,
    slots: stonetop::fixed::SlotCount::Zero,
...
static MOVE_RITES_OF_THE_LAND: stonetop::fixed::MoveFixed = stonetop::fixed::MoveFixed {
    ...
    description: "<p>Once per season, when you <strong><em>oversee the sacred rites</em></strong>, hold 1 Boon. If you also sacrifice 1 Surplus, hold 4 Boon instead. Spend Boon in lieu of Stock, 1-for-1.</p><p>When you <strong><em>publicly sacrifice something or someone much-loved</em></strong>, either clear a steading debility or gain advantage when the steading next rolls +Fortunes.</p>",
    requires: &[],
    max_picks: 1u8,
...
static MOVE_BINDING_ARBITRATION: stonetop::fixed::MoveFixed = stonetop::fixed::MoveFixed {
    ...
    description: "<p>When you <strong><em>bear witness to someone's promise or oath</em></strong>, henceforth you may ask their player if they have kept their word. They must answer honestly. The character need not be present. If <strong><em>they have broken their word</em></strong>, you gain advantage on all rolls against them until they admit their wrongdoing and suffer an appropriate consequence (your call).</p>",
...
static BACKGROUND_A_LIFE_OF_CRIME: stonetop::fixed::BackgroundFixed =
    stonetop::fixed::BackgroundFixed {
        ...
        description: &[
            ...
            stonetop::fixed::BackgroundChunk::Flavor(
                "<p>You start with either Burgle or Light Fingers (your choice) as an extra move, and either a burglar's kit or a hidden stash (your choice) as an additional special possession.</p>",
            ),
        ],
...
static SPECIAL_POSSESSION_DISTILLERY: stonetop::fixed::SpecialPossessionFixed =
    stonetop::fixed::SpecialPossessionFixed {
        ...
        name: "Distillery",
        description: "{skins of fine whisky|Skin of fine whisky}, {copper tubes}, {malt}, {firkins}, stills, barrels, etc.",
        resource: None,
        pick: &[],
        kit: stonetop::fixed::GizmoKit::Referenced(&[
            stonetop::keys::GizmoKey::SkinOfFineWhisky,
...
static PLAYBOOK_THE_JUDGE: stonetop::fixed::PlaybookFixed = stonetop::fixed::PlaybookFixed {
    ...
    hp: 20u8,
    special_possessions: stonetop::fixed::SpecialPossessions {
        pick_note: "Pick 1, in addition to your symbol of authority and scribe's tools",
        pick_count: 1u8,
        preselected: 2u8,
        options: &[
...
impl stonetop::keys::GizmoKey {
    ...
    pub fn fixed_part(self) -> &'static stonetop::fixed::GizmoFixed {
        match self {
            ...
            Self::SkinOfFineWhisky => &GIZMO_SKIN_OF_FINE_WHISKY,
            Self::PurseOfCoppers => &GIZMO_PURSE_OF_COPPERS,
            Self::FirkinOfFineWhisky => &GIZMO_FIRKIN_OF_FINE_WHISKY,
            ...
            Self::SkinOfCommonWhisky => &GIZMO_SKIN_OF_COMMON_WHISKY,
            Self::Awl => &GIZMO_AWL,
