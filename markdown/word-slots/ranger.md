...
- ☐ **Lay of the land** (3 uses): expend a use to know where to find ▁▁▁▁▁▁▁▁, without having to Know Things; GM can veto.
...
When you ***travel through the wilderness***, you can procure 1d6 uses of 1-slot provisions each day (roll with disadvantage in winter or barren terrain). Provisions can substitute for supplies when you Make Camp.

### ☐ Pack Horse

You can carry up to 4 inventory slots with a light load, 7 inventory slots with a normal load, and 10 inventory slots with a heavy load.
...
(Requires level 6+ and Home on the Range)
