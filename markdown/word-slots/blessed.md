...
- ☐ **The Wild:** mix and match 1-3 of these: Autumn, Badger, Big, Black, Bloody, Brave, Crow, Cub, Dark, Doe, Fang, Fierce, Flower, Gentle, Green, Grim, Hart, Leaf, Little, Lonely, Old, Owl, Pale, Pup, Quick, Quiet, Rain, Red, Sharp, Snake, Snow, Spring, Summer, Tall, Tree, Yellow, White, Wind, Winter, Wolf, Whisper
...
- ☐ **Apiary:** beeswax, candles (*close, area*, lasts ~1 hr), honey, 1-slot bee smokers, 1-slot hat & veils, etc.
...
- ☐ **Herb garden:** shears, mortars & pestles, herbs, seeds, remedies, mild poisons, 1-slot spades, etc. Each spring, d4 uses of bendis root (*reach, area*, burns ~1 hr, fumes repel perversions of nature).
