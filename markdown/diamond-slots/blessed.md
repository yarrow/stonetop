...
- ☑︎ **Sacred pouch** (*magical*): see back page. Stock: ◯◯◯
- ☐ **Apiary:** beeswax, candles (*close, area*, lasts ~1 hr), honey, ◇ bee smokers, ◇ hat & veils, etc.
- ☐ **Collected offerings** (◯◯◯ uses): Expend a use to produce something valuable to a spirit of the wild. Restore 1 use each season.
...
- ☐ **Herb garden:** shears, mortars & pestles, herbs, seeds, remedies, mild poisons, ◇ spades, etc. Each spring, d4 uses of bendis root (*reach, area*, burns ~1 hr, fumes repel perversions of nature).
