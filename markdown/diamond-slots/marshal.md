...
- ☐ **Chirurgeon's tools:** catgut, straps, bandages, tubes, poultice, willow bark, ◇ bonesaws, etc.
...
- ☐ **Weapons of war:** choose up to 3 (now or later):
  ...
  - ☐ ◇◇ Long spear, fine steel (*reach*, 2 piercing)
...
When you ***carry a shield***, mark only ◆ (instead of ◆◆). Also, you can ignore the *cumbersome* tag on any armor you wear.
