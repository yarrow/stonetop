...
- ☐ **Stonetop:** Bran, Carwyn, Delyth, Elin, Fion, Geral, Mair, Rannon, Vaughn, or Wynn
- ☐ **Barrier Pass:** Anarba, Batu, Bugadai, Hujaghur, Jigur, Kete, Sarantuya, or Tebengri
- ☐ **Gordin's Delve:** Pick a name from any list.
- ☐ **Marshedge:** Comyna, Crevan, Fitz, Greagir, Maired, Nainsi, Naiclas, or Saraid
- ☐ **Lygos or some other point south:** Amit, Baz, Dafna, Mahsa, Parviz, Sanaz, Tzofiya, Yaniv
...
Damage: d8 · HP (max 16): ▁▁▁▁ · Armor: ▁▁▁▁ · XP: ▁▁▁▁ · Level: ▁▁▁▁
...
- ☐ **Burglar's kit:** picks, files, snippers, wire, ◇ prybars, ◇ hacksaws, ◇ a lantern (◯◯◯◯◯ hours, *close, area*), ◇ a grappling hook, etc.
...
- ☐ **Hidden stash** (◯◯◯ uses): each use produces valuables worth a purse of silvers (Value 2)
- ☐ **Mummer's kit:** juggling balls, whirlybird seeds, motley, ribbons, bells, ◇ puppets, ◇ a fiddle, etc.
- ☐ **Scribe's tools:** parchment, ink, pigments, vials, quills, ◇ a notebook, etc.
- ☐ **Tannery** (or access to it): lime, acid, salts, thick gloves, ◇ a boiled leather cuirass (1 armor), etc.
...
3. On your third turn, **tell us your tall tales**. Feel free to embellish and exaggerate to the other players, but always answer the GM truthfully.
...
### ☐ All in the Wrist — ◯ a few left ◯ out
